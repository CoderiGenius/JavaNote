...
![](https://i.loli.net/2020/04/09/5FbnG8lHxeBvjqu.png)
...
###### 锁
![](https://p1.meituan.net/travelcube/9b6a41f7d8527df9730b7832b38ec4d5180025.png)
...
![通过原子变量CAS实现线程安全](https://p0.meituan.net/travelcube/de0ced42337014947e7466db4d8f2d4d158395.png)
...
![](https://p1.meituan.net/travelcube/69ce8ffbe7a4ebee01c377dac174842d433755.png)

- 当CPU执行运算的时候，它先去L1查找所需的数据、再去L2、然后是L3，如果最后这些缓存中都没有，所需的数据就要去主内存拿。走得越远，运算耗费的时间就越长。所以如果你在做一些很频繁的事，你要尽量确保数据在L1缓存中。
- 另外，线程之间共享一份数据的时候，需要一个线程把数据写回主存，而另一个线程访问主存中相应的数据。
- 下面是从CPU访问不同层级数据的时间概念:
![](https://i.loli.net/2020/04/09/Ne3OV2PZnKJdYkx.png)
...
![](https://p0.meituan.net/travelcube/192e9b87b7a5b68cac352fdeb81dc93b161543.png)
...
- 生产者单线程写数据的流程比较简单：
  ...
  - 若是返回的正确，则生产者开始写入元素。
![](https://p1.meituan.net/travelcube/e71c1449273361ec413fffc7b0bf5507208689.png)
#### 多个生产者
...
![](https://p0.meituan.net/travelcube/99c603494ea90c9535e165579daf340a161527.png)
### 写数据
- 多个生产者写入的时候：
  - 申请写入m个元素；
